...
https://kihoonshin.github.io/web_project/
...
### 2. 벽돌 , 아이템 벽돌 , 마리오 , 몬스터 , 파이프 , 태양 생성하기
 ...
 - 마리오의 크기가 작은 상태에서 몬스터한테 부딪히면 목숨 하나씩 줄어든다. / 마리오의 크기가 커진 상태에서 부딪히면 목숨은 줄어들지 않지만 몸이 다시 작아진다.
...
- 구현하는데 급급하여 아직 클래스와 파일들을 나누지 못하였음.
